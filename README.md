...
4. Add alias to the application file in your `.zshrc` or `.bashrc` `alias grails=PATH_TO_INDEX.js`
5. Add alias to the cli tool in your `.zshrc` or `.bashrc` `alias crails=PATH_TO_PROGRAM.js`
